...
import DirectProviders from "./Tables/DirectProviders";
  ...
  return (
    <div>
      ...
      >
        ...
        {results ? (
          <div>
            {results.DirectProviders.length > 0 ? (
              <DirectProviders data={results.DirectProviders} />
            ) : (
              <Typography
                variant="h3"
                component="h3"
                ...
                gutterBottom
              >
                No Direct Providers to be displayed
              </Typography>
            )}
          </div>
        ) : (
